...
The following people have [contributed](https://github.com/open-energy-transition/Open-TYNDP/graphs/contributors) significantly
...
This project builds upon the work of other communities, especially PyPSA-Eur and PyPSA communities. For the list of contributors, see the following links: [PyPSA-Eur](https://github.com/PyPSA/PyPSA-Eur/graphs/contributors) and [PyPSA](https://pypsa.readthedocs.io/en/stable/references/developers.html).
