...
## Option A: Windows Installer (Recommended for Windows) {#windows_installer}

For Windows users, the easiest way to install Open-TYNDP is using the automated installer. Download the latest installer executable (e.g., `open-tyndp-0.4.0-pixi-Windows-x86_64.exe`) from the [GitHub releases page](https://github.com/open-energy-transition/open-tyndp/releases) and run it.
...
## Option B: Manual installation (All Platforms) {#manual_installation}

### Clone the Repository {#clone_repo}

First of all, clone the [Open-TYNDP repository](https://github.com/open-energy-transition/open-tyndp) using the version control system `git` in the command line.
